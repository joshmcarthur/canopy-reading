...
describe('OpenLibrary Integration', () => {
  ...
  describe('searchBookByTitleAndAuthor', () => {
    it('should successfully find a book by title and author', async () => {
      ...
      const result = await searchBookByTitleAndAuthor('Another Book', 'Another Author');
    ...
    it('should return null when no results found', async () => {
      ...
      const result = await searchBookByTitleAndAuthor('Nonexistent Book', 'Unknown Author');
      expect(result).toBeNull();
    });
    ...
    it('should handle publish_year array', async () => {
      ...
      const result = await searchBookByTitleAndAuthor('Test Book', 'Test Author');
  ...
  describe('searchBook', () => {
    it('should prioritize ISBN search when ISBN is provided', async () => {
      ...
      const result = await searchBook('Some Title', 'Some Author', '9781111111111');
    ...
    it('should fall back to title+author when ISBN search fails', async () => {
      ...
      const result = await searchBook('Title Author Book', 'Title Author', '9999999999999');
  ...
  describe('metadata extraction edge cases', () => {
    ...
    it('should handle minimal book data', async () => {
      ...
      const result = await searchBookByTitleAndAuthor('Minimal Book', 'Minimal Author');
